...
const AdminLayout = () => {
  ...
  const adminNavLinks = [
    ...
    { to: "/admin/siteContacts", text: "Contatos do site", icon: Contact },
  ];
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <motion.aside
        initial={
          isMobile ? "closed" : isDesktopSidebarCollapsed ? "closed" : "open"
        }
        animate={
          isMobile
            ? isSidebarOpen
      ...
      >
        <div
          className={`flex items-center justify-between p-4 h-20 border-b border-border ${
        ...
        >
          ...
          >
            ...
            <motion.span
              ...
              initial={
                isDesktopSidebarCollapsed && !isMobile ? "closed" : "open"
              }
              animate={
                isDesktopSidebarCollapsed && !isMobile ? "closed" : "open"
              }
        ...
        <nav className="flex-grow py-6 space-y-2 overflow-y-auto">
          {adminNavLinks.map((link) => (
            ...
            >
              <link.icon
                size={isDesktopSidebarCollapsed && !isMobile ? 24 : 20}
        ...
        >
          <Button
            ...
            onClick={toggleTheme}
            className={`w-full flex items-center justify-start text-foreground/70 hover:text-primary hover:bg-primary/10 ${
              isDesktopSidebarCollapsed && !isMobile ? "justify-center" : ""
            }`}
            aria-label={
              theme === "light"
          ...
          <Button
            ...
            className={`w-full flex items-center justify-start text-red-500 hover:text-red-600 hover:bg-red-500/10 ${
              isDesktopSidebarCollapsed && !isMobile ? "justify-center" : ""
            }`}
          >
            <LogOut size={20} />
