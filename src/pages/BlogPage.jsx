...
const BlogPage = () => {
  ...
  const pageDescription = "Acompanhe as últimas notícias, artigos e inovações no setor de engenharia. O blog da Engbras traz conteúdo relevante para profissionais e entusiastas.";
  const keywords = "blog de engenharia, notícias de engenharia, inovação na construção, artigos técnicos, Engbras blog";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:image" content="https://seu-dominio-engbras.com/og-image-blog.jpg" /> 
        <meta property="og:image:alt" content="Página do Blog da Engbras com listagem de artigos." />
      </Helmet>
      <motion.div
        initial="initial"
        animate="in"
      ...
      >
        <div className="text-center mb-12">
          ...
          >
            Fique por dentro das últimas notícias, insights e inovações no mundo da engenharia.
          </motion.p>
        </div>
        ...
        {filteredPosts.length === 0 ? (
          ...
          >
            {searchTerm ? "Nenhum post encontrado para sua busca." : "Nenhum post encontrado ainda. Volte em breve!"}
          </motion.p>
        ) : (
            ...
            {filteredPosts.map((post, index) => (
              ...
              >
                {post.imageUrl && (
                  <Link to={`/blog/${post.id}`} className="block overflow-hidden">
                    <motion.img 
                      ...
                      src={post.imageUrl || "https://images.unsplash.com/photo-1675023112817-52b789fd2ef0"}
                ...
                <div className="p-6 flex-grow flex flex-col">
                  <h2 className="text-2xl font-semibold text-engbras-gray-dark mb-3 hover:text-engbras-orange transition-colors" style={{ fontFamily: "'Roboto Slab', serif" }}>
                  ...
                  <p className="text-engbras-gray-dark mb-6 line-clamp-4 flex-grow leading-relaxed">{post.summary || post.content.substring(0, 120) + "..."}</p>
                  <Button asChild variant="outline" className="mt-auto border-engbras-orange text-engbras-orange hover:bg-engbras-orange hover:text-engbras-white self-start group transition-all duration-300">
